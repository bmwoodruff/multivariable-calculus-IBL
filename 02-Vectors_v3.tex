...
\href{http://en.wikipedia.org/wiki/Matrix\_multiplication}{Wikipedia} for an explanation. Alternatively see below for a visualization of the idea.
...
For example, consider the matrix $A = \begin{bmatrix}1&0&0\\0&2&0\\0&0&3}\end{bmatrix}$.  Starting from the origin, each column represents an edge of the rectangular box 
$0\leq x\leq 1$, 
$0\leq y\leq 2$, 
