...
%=====================================================================
% Define two large macros for end of chapters. 
% Currently inside if-stuff to allow either to be picked.
%-----------------------------------------------------------
\newcommand{\wrapup}{
\bmw{\section{Wrap Up}
...
\ifstewart
	...
	\newcommand{\stewartsbrief}[1]{#1}
\else
	\newcommand{\stewarts}[1]{}
	\newcommand{\stewartsbrief}[1]{}
\fi
...
\newtheorem{challengenum}{Challenge Problem}[chapter]
...
\author{Ben Woodruff\thanks{Mathematics Faculty at Brigham Young
    University--Idaho, \url{woodruffb@byui.edu}}\\
		Modified by Karl Schmitt\thanks{Valparaiso University -- Indiana, \url{karl.schmitt@valpo.edu}}}
\date{Typeset on \today\\
\vfill
\includegraphics[height=1.3cm]{by-sa.eps}
\vfill
\larsonfiveshort{With references to \emph{Calculus, Early Transcendental
...
\noindent\copyright{ Modifications 2014- Karl Schmitt. Some Rights Reserved.}
...
\noindent Furthermore, this deriviative with edits and modifications by Karl Schmitt similarly requires that you give additional editing/modification credit to Karl Schmitt. Please attribute these modifications and edits to Karl R. B. Schmitt, Mathematics and Statistics Faculty at Valparaiso University--Indiana, \url{karl.schmitt@valpo.edu}
...
\note{In the Latex Main file, there should probably be an option for turning on Ben's original chapters here instead of Kar's sliced and diced chapters}
