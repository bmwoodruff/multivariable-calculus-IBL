...
\instructor{Recommended Pre-Class} 
\marginpar{
...
\begin{enumerate}
	...
	\bmw{\item What are the foci of the resulting object (it's a conic section)?}
\end{enumerate}
\end{problem}

\begin{problem}\label{prob:line equation practice}\marginpar{What we did in the vector unit should help here.}
...
\begin{enumerate}
  ...
  \bmw{\item Now find the focus of the resulting curve.}
\end{enumerate}
