...
\begin{enumerate}
	\item \marginpar{See exercise \ref{prob:horse track chain}}%
...
\begin{enumerate}
 ...
 \item Consider the vector field $\vec F(x,y)=(2x+y,x+4y)$. 
	\begin{enumerate}
		...
		\item What are $f_{xy}$ and $f_{yx}$?
	\end{enumerate}
 \item \marginpar{See exercise \ref{prob:second partials agree}.}%
...
\begin{enumerate}
	\item Draw the surface $f$ in 3D.
		...
		\end{enumerate}
  \item What's the maximum height and minimum height of the sheet? \marginpar{See exercise \ref{prob:horse track chain}.}
