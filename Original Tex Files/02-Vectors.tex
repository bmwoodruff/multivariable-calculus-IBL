...
Find the distance between the two points $P=(2,3,-4)$ and $Q=(0,-1,1)$. Then find an equation of the sphere passing though point $Q$ whose center is at $P$. \valpo{Hint: Each point on the surface of a sphere is $r$ distance away from the center.}
\end{problem}
