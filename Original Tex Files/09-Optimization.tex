...
\valpo{ This chapter addresses the following topical objectives:
\begin{enumerate}
...
$g(x,y)=2x-y$, and 
$h(x,y)=\sin x\cos y$. 
 \marginpar{You'll want a computer to help you construct the graphs, particularly $h$. \bmw{Please use the Mathematica introduction in Brainhoney.} You could use Wolfram Alpha (use the links in the function chapter if you forgot how to graph).}
\begin{enumerate} 
